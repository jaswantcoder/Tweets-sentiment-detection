...
#search_words = ["suicide", "depression", "depressed", "sad", "death", "failed", "lost", "broken", "disease", "accident"]

tweetcount=0;

#search_words = ["glad","joy","new","welcome","congrats","depressed","sad","alone","stressed","upset"];
#search_words = ["stressed","upset","glad","joy","new","welcome","congrats"];
#search_words = ["joy","new","welcome","congrats"];
#search_words = ["new","welcome","congrats"];
#search_words = ["stressed","upset"];
#search_words = ["welcome","congrats","depressed","sad","alone","stressed","upset"];
#search_words = ["congrats","depressed","sad","alone","stressed","upset"];
#search_words = ["glad","joy","new","welcome"]
#search_words = ["upset"];
#search_words = ["stressed","upset"]



#search_words = ["depressed","sad","alone","stressed","upset"];
